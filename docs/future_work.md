...
## 4. Security: Rate Limiting & Auth 📝 **Documented**
*   **Status**: Guidelines provided in `docs/security_guidelines.md`.
*   **Implementation**: Open to implementation (OAuth2/OIDC) for enterprise deployments.
